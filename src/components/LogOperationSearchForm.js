...
//
class LogOperationSearchForm extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			expand: false,
				...
				</Row>
				{
					...
					?<div>
						...
						<Row gutter={{xs: 8, sm: 16, md: 24}} style={{marginBottom:15}}>
							...
							<Col xs={24} sm={24} md={12} lg={12} xl={8}>
								<FormItem label={"操作备注"} className="ApSearchItem" style={{display: 'flex'}}>
									{getFieldDecorator('clientName')(
										<Input placeholder="请输入操作备注" />
									)}
								</FormItem>
							</Col>
							<Col xs={24} sm={24} md={12} lg={12} xl={8}>
...
//
LogOperationSearchForm.propTypes = {
	form: PropTypes.object,
};

const LogOperationSearchFormWrapper = Form.create()(LogOperationSearchForm);

export default LogOperationSearchFormWrapper;