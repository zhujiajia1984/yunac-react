...
//
export default class SubRoleTable extends React.Component {
	//
	constructor(props) {
		super(props);
		this.state = {
					...
					>
						...
						<TreeNode title="设备管理" key="dev">
							...
							<TreeNode title="探针管理" key="tz">
								...
								<TreeNode title="探针型号管理" key="tzType">
									<TreeNode title="管理" key="tzTypeAll"></TreeNode>
									<TreeNode title="只读" key="tzTypeReadOnly"></TreeNode>
								</TreeNode>
							</TreeNode>
